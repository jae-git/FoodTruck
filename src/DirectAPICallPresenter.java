...
public class DirectAPICallPresenter{
	FoodTruckUpstreamConsumer foodTruckUpstream;

	public DirectAPICallPresenter() throws Exception {
		this.foodTruckUpstream = FoodTruckUpstreamConsumer.createDefaultUpstreamConsumer();
	}
	...
	public void interactivePresentation() throws Exception {
		...
		while (foodTruckUpstream.hasNext()) {

			System.out.println("=========================================================================================================");
			System.out.println(" Name	          \t Address (and other information)            "+foodTruckUpstream.pageInfo());
			System.out.println("---------------- \t-----------------------------------------------------------------------");

			List<FoodTruck> foodTrucks = foodTruckUpstream.next();				
